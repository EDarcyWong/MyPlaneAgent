...
export type AgentWebAccess='disabled'|'ask'|'allow'
export type AgentApprovalMode='ask'|'auto'|'full'|'unrestricted'
export type AgentCommandApproval={key:string;label:string;createdAt:string}
...
export type AgentPreview={changes?:{path:string;before?:string;after:string}[];path?:string;before?:string;after?:string;command?:string;cwd?:string;note?:string;approvalLabel?:string}
...
export type AgentProject={pinned?:boolean;policy?:AgentPolicy;webAccess?:AgentWebAccess;webAllowSyntheticIp?:boolean;autoWritePaths?:string[];memory?:string;id:string;name:string;workspace:string;createdAt:string;updatedAt:string}
...
export type AgentCommands={
 ...
 agentUpdateProject:{input:{id:string;policy:AgentPolicy;webAccess:AgentWebAccess;webAllowSyntheticIp:boolean;autoWritePaths:string[];memory?:string};output:AgentProject}
 ...
 agentApprove:{input:{id:string;eventId:string;approved:boolean;scope?:'once'|'similar'};output:void}
